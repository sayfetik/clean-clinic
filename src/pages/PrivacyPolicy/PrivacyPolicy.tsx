  ...
  <div>
    ...
    <div className={css.root}>
      ...
      <p>
        ...
        персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ООО “КЛИН ПРОДАКТС”
        (далее – Оператор).
      </p>
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора <a href="mailto:info@clean-clinic.ru">info@clean-clinic.ru</a>{' '}
