  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Плазмолифтинг для омоложения и восстановления кожи в клинике Клин Клиник, Оренбург. Сертифицированные врачи, лицензии."
        />
        <meta
          name="keywords"
          content="Плазмолифтинг Оренбург, Клин Клиник, омоложение, восстановление, лицензия, врачи"
        />
      </Helmet>
