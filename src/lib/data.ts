...
export const massage = {
  ...
  whatItIsText: 'Механическая стимуляция, способствующая регенерации тканей позволяет получать безупречные результаты как в эстетике, так и в реабилитации тела.',
...
export const plasmolifting = {
  ...
  whatItIsText: 'Процедура стимулирует регенерацию тканей, улучшает цвет лица, разглаживает морщины и повышает упругость кожи. Безопасный и эффективный способ вернуть молодость и красоту!',
  indicationsTitle: 'Показания',
  indications: [
    'Морщины и складки',
  ...
  services: [
      {
        ...
        description: 'Выпадение волос — проблема, волнующая многих. Плазмолифтинг предлагает эффективное и безопасное решение. Волосы получают необходимые питательные вещества, укрепляются от корней до кончиков и обретают прежний блеск и силу.',
        cost: 5000,
      ...
      },
      {
        ...
        description: 'Избавитесь от морщин, пигментных пятен и тусклого цвета лица с помощью плазмолифтинга. Эта безопасная и эффективная процедура, использующая вашу собственную плазму крови, активирует естественные процессы омоложения.',
        cost: 5000,
      ...
      },
      {
        id: 3,
        name: 'Зона декольте',
        description: 'Благодаря введению собственной обогащенной тромбоцитами плазмы, кожа декольте восстанавливает свою эластичность, разглаживаются морщины, улучшается цвет лица, а кожа приобретает здоровое сияние.',
        cost: 6000,
      ...
      },
      {
        ...
        description: 'Благодаря плазмолифтингу кожа рук становится более увлажненной, сухость и шелушение уменьшаются, мелкие и средние морщины становятся менее заметными.',
        cost: 3000,
        img: '/assets/cryoCard3.jpeg',
      },
    ],
...
export const analyzes = {
  ...
  paragraph1: 'Сдай анализы в Clean Clinic и получи полную информацию о своем здоровье. У нас есть полный спектр лабораторных исследований, которые помогут вам получить точные и достоверные результаты. Не откладывайте свое здоровье на потом – обратитесь в Clean Clinic. Ваше здоровье - наш приоритет.',
  paragraph2: 'Анализы принимаем на голодный желудок с понедельника по пятницу с 8:00 до 11:00, суббота с 9:00 до 11:00.',
  ...
  services: [
      ...
      },
      {
        ...
        bullets: ['ТГ, Свободный Т3, Т4, АТ-ТПО, АТ-ТГ, Кальциотонин, Ферритин, Витамин А, Е, Д, Фолиевая кислота, Витамин В12, Селен'],
        cost: 15765,
        img: '/assets/analyzesCard.jpeg',
      },
      {
      ...
      },
      {
        ...
        bullets:['Глюкоза, Гликированный гемоглобин, Холестерин общий, ЛПНП, ЛПВП, ТГ, ТТГ, Свободный Т3, Т4, Лептин, Пролактин, Инсулин'],
        cost: 5300,
        img: '/assets/analyzesCard.jpeg',
      },
      {
      ...
      },
      {
        ...
        bullets: ['Общий тестостерон, Свободный тестостерон, Глобулин, связывающий половые гормоны, Дигидротестостерон, Фолликулостимулирующий гормон (ФСГ), Лютеинизирующий гормон (ЛГ), Пролактин, Эстрадиол, ТТГ, Свободный Т4'],
        cost: 6550,
        img: '/assets/analyzesCard.jpeg',
      },
      {
        ...
        bullets: ['ОАК (развернутый), Глюкоза, Холестерин, ЛПНП, ЛПВП, ТТГ, Витамин Д, Витамины В1, В6, В12, Кальций, Магний'],
        cost: 11160,
        img: '/assets/analyzesCard.jpeg',
      },
      {
        ...
        bullets: ['Фолликулостимулирующий гормон (ФСГ), Лютеинизирующий гормон (ЛГ), Пролактин, Эстрадиол, Свободный андрогенный индекс (Общий тестостерон, Глобулин, связывающий половые гормоны), Дигидроэпиандростерон сульфат (ДГЭА – SO4), ТТГ, Свободный Т4, Кортизол в слюне (1 порция)'],
        cost: 5399,
        img: '/assets/analyzesCard.jpeg',
      },
      {
...
'Дополнительно: Общий белок, Ферритин, Магний, ТТГ, Кальций общий, Витамин Д, Витамин В12',
      ...
      },
      {
        id: 15,
        name: 'Чек-ап «Осенний»',
        bullets: ['ОАК развернутый, Глюкоза, Холестерин общий, ЛПНП, ЛПВП, Ферритин, Витамин Д, Магний, Калий, Натрий, Кальций'],
        cost: 4995,
        img: '/assets/analyzesCard.jpeg',
      },
    ],
...
export const solarium = {
  ...
  whatItIsText: 'В солярии с COLLATAN лампами вы получаете не просто загар, а комплексный уход за кожей. Инновационная технология, объединяющая силу четырех спектров света – ультрафиолетового, красного, синего и белого – подарит вам роскошный, ровный загар и одновременно омолодит вашу кожу.',
  paragraphTitle: 'Инновационная технология, объединяющая четыре спектра света, подарит вам:',
  paragraph: [
    'Роскошный, ровный загар',
'Омолаживающий эффект',
'Защиту от негативного воздействия ультрафиолета',
  ],
  servicesTitle: 'Абонементы',
  services: [
      {
